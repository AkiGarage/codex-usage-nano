...
Codex Usage Nano は、Codex の残り使用量をすばやく確認するための軽量な macOS アプリです。
...
1. GitHub Releases から `CodexUsageNano-0.0.1-macos.zip` をダウンロードします。
2. zip を展開します。
...
Codex Usage Nano is a lightweight macOS app for checking remaining Codex usage quickly.
...
1. Download `CodexUsageNano-0.0.1-macos.zip` from GitHub Releases.
2. Unzip it.

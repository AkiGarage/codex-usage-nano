...
- Added compressed README demo assets from the supplied macOS screen recording.
...
- Replaced the preview image / MP4 link with a 3.5 MB inline GIF so the demo renders directly in the README.
